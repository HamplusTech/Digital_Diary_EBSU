...
Public Class frmschedule
 ...
 & "fd,DT,SATAtype)" _
            ...
            jp.Parameters.AddWithValue("@em", "Schedule")
            jp.ExecuteNonQuery()
            Me.Close()
            Dim a = MsgBox("Schedule is saved successfully", MsgBoxStyle.OkOnly, Title:="Samtech Digital Diary")
    ...
    Private Sub frmschedule_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            jp.Parameters.AddWithValue("@ty", "Schedule")
            jp.ExecuteNonQuery()
