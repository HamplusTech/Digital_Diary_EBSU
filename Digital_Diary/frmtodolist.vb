...
Public Class frmtodolist
 ...
 & "fd,DT,SATAtype)" _
            ...
            jp.Parameters.AddWithValue("@em", "ToDO")
            jp.ExecuteNonQuery()
            Me.Close()
            Dim a = MsgBox("To Do Item is saved successfully", MsgBoxStyle.OkOnly, Title:="Samtech Digital Diary")
    ...
    Private Sub frmtodolist_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            jp.Parameters.AddWithValue("@ty", "ToDo")
            jp.ExecuteNonQuery()
